...
export function TermsAdminPage() {
  const { data: pageData, isLoading } = useLegalPage("terms-and-conditions")
  const queryClient = useQueryClient()

  // State
  const [badge, setBadge] = useState("TERMS & CONDITIONS")
  ...
  const handleAddSection = () => {
    setSections([
      ...sections,
      {
        ...
        body: "Enter detailed clause terms, specifications, or legal guidelines here.",
      },
    ])
  }
  ...
  const saveMutation = useMutation({
    mutationFn: async () => {
      return api.put("/legal/terms-and-conditions", {
        badge,
        title,
        subtitle,
        lastUpdated,
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["legalPage", "terms-and-conditions"] })
      toast.success("Terms & Conditions page updated successfully!")
    },
    onError: (err: ApiError) => {
      toast.error(err.message || "Failed to update Terms & Conditions page.")
    },
  })
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-5">
        <div>
          <h1 className="text-2xl font-bold tracking-tight flex items-center gap-2">
            ...
            Terms & Conditions Page CMS
          </h1>
          <p className="text-sm text-muted-foreground mt-1">
            Manage public Terms & Conditions guidelines, trade clauses, and contract policies.
          </p>
        </div>
        <Button onClick={handleSubmit} disabled={saveMutation.isPending} className="gap-2 shrink-0">
          ...
          {saveMutation.isPending ? "Saving..." : "Save Terms Page"}
        </Button>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Configure top hero header elements displayed on the public Terms & Conditions page.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="Terms and Conditions of Export & Supply"
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="Brief introduction explaining commercial policies..."
                className="mt-1"
              />
            </div>
          </CardContent>
          ...
          <CardHeader className="flex flex-row items-center justify-between space-y-0">
            <div>
              <CardTitle className="text-base flex items-center gap-2">
                ...
                Terms Clauses & Policy Sections
              </CardTitle>
              <CardDescription>
                Add, edit, or remove specific policy sections displayed as content cards.
              </CardDescription>
            </div>
            <Button
              type="button"
              ...
              className="gap-1.5"
            >
              <Plus className="size-4" /> Add Clause Section
            </Button>
          </CardHeader>
          ...
          <CardContent className="space-y-6 pt-4">
            {sections.length === 0 ? (
              <div className="rounded-lg border border-dashed p-6 text-center text-sm text-muted-foreground">
                No policy sections added yet. Click &quot;Add Clause Section&quot; above to create one.
              </div>
            ) : (
                ...
                >
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      placeholder="Enter detailed contractual guidelines..."
                      className="mt-1"
                    />
                  </div>
                </div>
        ...
        <div className="flex justify-end pt-2">
          <Button type="submit" disabled={saveMutation.isPending} size="lg" className="gap-2">
            ...
            {saveMutation.isPending ? "Saving Changes..." : "Save Terms Page"}
          </Button>
        </div>
      </form>
    </div>
